...
def main():
    with st.form('prediction_form'):
        ...
        Administrative = st.slider("Select Administrative: ", min_value = 0, max_value = 30,  value = 3)
        Administrative_duration = st.slider("Select Administrative Duration: ", min_value = 0.0, max_value = 3000.0, value = 32.5, step = 0.1)
        ...
        Exit_Rate = st.slider("Select Exit Rate: ", min_value = 0.0, max_value = 0.2, step = 0.0001)
        Page_Values = st.slider("Select Page Values: ", min_value = 0.0, max_value = 400.0, step = 0.001)
        Special_Days = st.slider("Select Special days: ", min_value = 0.0, max_value = 1.0, value = 0.4, step = 0.2)
