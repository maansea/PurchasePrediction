...
def main():
    with st.form('prediction_form'):
        ...
        Bounce_Rate = st.slider("Select Bounce Rate: ", 0.0, 10, value = 2)
        Exit_Rate = st.slider("Select Exit Rate: ", 0.0, 10, value = 1 )
        Page_Values = st.slider("Select Page Values: ", 0.0, 400.0, value = 51)
