...
#          Month = LabelEncoder(Month, options_Month)
         ...
         dfr = np.array([Administrative
                         #Administrative_duration, Informational, Informational_duration, Product_Related,
                            #Product_Related_Duration, Exit_Rate, Bounce_Rate, Page_Values, Special_Days, Operating_Systems, 
                            #Browser, Region, Traffic_Type, Visitor_Type, Weekend, Month, 
                        ]).reshape(-1,1)
